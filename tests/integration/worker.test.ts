...
describe('Worker Integration Tests', () => {
  describe('Root endpoint /', () => {
    it('should return API info JSON', async () => {
      const request = new Request('https://techbadges.santosr.xyz/');
  ...
  describe('Icons endpoint /icons', () => {
    it('should generate SVG for valid icons', async () => {
      const request = new Request('https://techbadges.santosr.xyz/icons?i=js,ts,react');
      const response = await worker.fetch(request, createEnv(), createMockContext());
    ...
    it('should return 400 for missing icons parameter', async () => {
      const request = new Request('https://techbadges.santosr.xyz/icons');
      const response = await worker.fetch(request, createEnv(), createMockContext());
    ...
    it('should support theme parameter', async () => {
      const darkRequest = new Request('https://techbadges.santosr.xyz/icons?i=github&t=dark');
      const darkResponse = await worker.fetch(darkRequest, createEnv(), createMockContext());
      const darkSvg = await darkResponse.text();

      const lightRequest = new Request('https://techbadges.santosr.xyz/icons?i=github&t=light');
    ...
    it('should support perline parameter', async () => {
      const request = new Request(
        'https://techbadges.santosr.xyz/icons?i=js,ts,react,vue,angular&perline=5'
      );
      const response = await worker.fetch(request, createEnv(), createMockContext());
    ...
    it('should handle ETag-based caching', async () => {
      const request1 = new Request('https://techbadges.santosr.xyz/icons?i=js');
      const response1 = await worker.fetch(request1, createEnv(), createMockContext());
      const etag = response1.headers.get('ETag');
      expect(etag).toBeDefined();

      const request2 = new Request('https://techbadges.santosr.xyz/icons?i=js', {
    ...
    it('should skip invalid icons and use valid ones', async () => {
      const request = new Request('https://techbadges.santosr.xyz/icons?i=js,invalidicon,ts');
      const response = await worker.fetch(request, createEnv(), createMockContext());
    ...
    it('should return 400 when all icons are invalid', async () => {
      const request = new Request('https://techbadges.santosr.xyz/icons?i=invalid1,invalid2');
      const response = await worker.fetch(request, createEnv(), createMockContext());
  ...
  describe('API endpoints', () => {
    it('GET /api/icons should return icon list', async () => {
      const request = new Request('https://techbadges.santosr.xyz/api/icons');
      const response = await worker.fetch(request, createEnv(), createMockContext());
    ...
    it('GET /api/svgs should return SVG map', async () => {
      const request = new Request('https://techbadges.santosr.xyz/api/svgs');
      const response = await worker.fetch(request, createEnv(), createMockContext());
  ...
  describe('Health endpoint /health', () => {
    it('should return health status', async () => {
      const request = new Request('https://techbadges.santosr.xyz/health');
      const response = await worker.fetch(request, createEnv(), createMockContext());
  ...
  describe('CORS handling', () => {
    it('should handle OPTIONS preflight requests', async () => {
      const request = new Request('https://techbadges.santosr.xyz/icons?i=js', {
        method: 'OPTIONS',
      });
      const response = await worker.fetch(request, createEnv(), createMockContext());
  ...
  describe('Error handling', () => {
    it('should return 404 for unknown endpoints', async () => {
      const request = new Request('https://techbadges.santosr.xyz/unknown');
      const response = await worker.fetch(request, createEnv(), createMockContext());
  ...
  describe('Input validation', () => {
    it('should reject invalid theme values', async () => {
      const request = new Request('https://techbadges.santosr.xyz/icons?i=js&t=invalid');
      const response = await worker.fetch(request, createEnv(), createMockContext());
    ...
    it('should reject out-of-range perline values', async () => {
      const request = new Request('https://techbadges.santosr.xyz/icons?i=js&perline=100');
      const response = await worker.fetch(request, createEnv(), createMockContext());
    ...
    it('should enforce maximum icon limit', async () => {
      ...
      const request = new Request(`https://techbadges.santosr.xyz/icons?i=${icons}`);
      const response = await worker.fetch(request, createEnv(), createMockContext());
  ...
  describe('Icon aliases', () => {
    it('should resolve js to javascript', async () => {
      const jsRequest = new Request('https://techbadges.santosr.xyz/icons?i=js');
      const jsResponse = await worker.fetch(jsRequest, createEnv(), createMockContext());
      const jsSvg = await jsResponse.text();

      const javascriptRequest = new Request('https://techbadges.santosr.xyz/icons?i=javascript');
    ...
    it('should resolve ts to typescript', async () => {
      const tsRequest = new Request('https://techbadges.santosr.xyz/icons?i=ts');
      const tsResponse = await worker.fetch(tsRequest, createEnv(), createMockContext());
      const tsSvg = await tsResponse.text();

      const typescriptRequest = new Request('https://techbadges.santosr.xyz/icons?i=typescript');
